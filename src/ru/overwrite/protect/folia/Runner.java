...
public class Runner extends BukkitRunnable {
    ...
    }, 2L, 40L * 50L, TimeUnit.MILLISECONDS);
 }
    ...
    public void adminCheck() {
        ...
        }, 2L, 20L * 50L, TimeUnit.MILLISECONDS);
    }
    ...
    public void startMSG() {
        ...
        }, 2L, config.getInt("message-settings.delay") * 20L * 50L, TimeUnit.MILLISECONDS);
    }
    ...
    public static void checkFail(ServerProtector plugin, Player p, List<String> command) {
    	Bukkit.getGlobalRegionScheduler().run(plugin, (a) -> {
